...
if (Mobile.callTestCase(findTestCase('Test Cases/Login/Log In'),[:], FailureHandling.OPTIONAL)== true){
	Mobile.callTestCase(findTestCase('Control/Transplace/Seleccionar Transplace'),[:], FailureHandling.OPTIONAL)
}
else {
