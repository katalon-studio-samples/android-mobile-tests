...
Mobile.tap(findTestObject('Object Repository/v7.6/android.widget.TextView - Graphics'), GlobalVariable.G_Timeout)
...
'Get item\'s label'
def itemText = Mobile.getText(findTestObject('Object Repository/v7.6/Graphics/android.widget.TextView - Xfermodes'), GlobalVariable.G_Timeout)
