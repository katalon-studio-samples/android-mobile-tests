...
Mobile.comment('03082020T9')

Mobile.scrollToText('03082020T9')

def itemText = Mobile.getText(findTestObject('null'), GlobalVariable.G_Timeout)

Mobile.verifyEqual(itemText, '03082020T9')

Mobile.tap(findTestObject('null'), 0)

Mobile.tap(findTestObject('Object Repository/rc/Shipment/android.widget.Button - OK'), 0)
