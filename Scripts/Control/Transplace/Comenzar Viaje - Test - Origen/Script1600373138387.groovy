...
Mobile.comment('170920T7')
Mobile.scrollToText('170920T7')

Mobile.takeScreenshot()

/*
 new UiSelector().className("android.widget.Button").text("REGISTRATE").packageName("com.recursoconfiable.tracking").enabled(true).clickable(true)
 .longClickable(false).checkable(false).checked(false).focusable(true).focused(false).scrollable(false).selected(false).index(0)
 
public class Selector{
	
	public UiSelector Selector1(String a){
		return new UiSelector().className("android.widget.Button").text(a).packageName("com.recursoconfiable.tracking").enabled(true).clickable(true)
		.longClickable(false).checkable(false).checked(false).focusable(true).focused(false).scrollable(false).selected(false).index(0)
	}
}
*/
